...
public class FreeProxyLists extends TestCase{
	...
	public void test() throws FailingHttpStatusCodeException, MalformedURLException, IOException{
		...
		String ipAddress=jPage.getElementsByClass("DataGrid").get(0).getElementsByTag("tbody").get(0)
				.getElementsByClass("odd").get(0).getElementsByTag("td").get(0).getElementsByTag("a")
				.get(0).text();
